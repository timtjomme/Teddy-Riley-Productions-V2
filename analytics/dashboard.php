...
<style>
  *{box-sizing:border-box}
  ...
  h1{font-weight:300;font-size:32px;margin:0 0 6px;letter-spacing:-0.01em}
  ...
  .grid3{display:grid;grid-template-columns:repeat(3,1fr);gap:28px;margin-bottom:32px}
  ...
  .bars{display:flex;align-items:flex-end;gap:3px;height:130px;background:#fff;border:1px solid rgba(0,0,0,0.08);border-radius:16px;padding:16px;margin-bottom:32px}
  .bar-wrap{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:100%}
  .bar{width:100%;background:#121214;border-radius:3px 3px 0 0;min-height:2px}
  .bar-label{font-size:9px;color:#9a9aa4;margin-top:4px}
  .empty{color:#9a9aa4;font-size:14px;padding:20px;background:#fff;border:1px solid rgba(0,0,0,0.08);border-radius:16px}
  .j-pages{color:#63636b;font-size:13px}
  .note{color:#63636b;font-size:12.5px;line-height:1.7;margin-top:34px}
  code{background:rgba(0,0,0,0.06);padding:1px 5px;border-radius:3px;font-size:11.5px}
</style>
